...
import HotGoods from './component/HotGoods.vue';
    ...
    <div class="container" >
      <div class="bread-container" >
        <el-breadcrumb separator=">" >
            <!-- 一开始页面渲染的时候goodsdetail是空对象{}，不存在categories，是undefined -->
            <!-- 可采取的两种方式：可选链 v-if -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img :src="img" alt="" v-for="img in goodsDetail.details.pictures" :key="img" >
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
            <div class="goods-aside">
                <HotGoods :type="1"></HotGoods>
                <HotGoods :type="2"></HotGoods>
            </div>
          </div>
        </div>
      </div>
